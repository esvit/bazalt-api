...
abstract class Comment extends \Bazalt\ORM\Record
{
    ...
    const MODEL_NAME = 'Components\\Events\\Model\\Comment';
    ...
    {
        $this->hasRelation('Elements', new \Bazalt\ORM\Relation\NestedSet('News\Model\Comment', 'news_id'));
        $this->hasRelation('User', new \Bazalt\ORM\Relation\One2One('News\Model\User', 'user_id',  'id'));
        $this->hasRelation('Article', new \Bazalt\ORM\Relation\One2One('News\Model\Article', 'news_id',  'id'));
    }
